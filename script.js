...
function notifyGameStart() { speakNarration('gameStart'); const notification = document.getElementById('gameNotification'); if (notification) { notification.textContent = "게임 시작\nGame Start!"; notification.classList.add('show'); setTimeout(() => notification.classList.remove('show'), 1500); } }
